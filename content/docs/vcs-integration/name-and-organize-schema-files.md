...
![Directory per environment, each file corresponds to a single database under an environment](/docs/vcs-integration/name-and-organize-schema-files/organize-schema-files-step1.webp)
...
![A single file representing all databases having the same name from all environments.](/docs/vcs-integration/name-and-organize-schema-files/organize-schema-files-step3.webp)

![organize-schema-files-step](/docs/vcs-integration/name-and-organize-schema-files/organize-schema-files-step4.webp)
...
![organize-schema-files-step](/docs/vcs-integration/name-and-organize-schema-files/organize-schema-files-step5.webp)
