  ...
  return (
    ...
    >
      <div className="container gap-x-grid grid grid-cols-12 md:grid-cols-none">
        ...
        <div className="relative col-start-5 col-end-13 self-stretch pt-[100px] before:absolute before:bottom-0 before:top-0 before:right-[166px] before:w-[252px] before:bg-automation-changes 3xl:pt-[84px] 3xl:before:right-10 xl:col-start-6 xl:pt-[115px] xl:before:right-5 xl:before:w-[216px] md:col-auto md:-mx-7 md:pt-10 md:pb-10 md:before:right-0 md:before:top-auto md:before:h-[315px] md:before:w-full md:before:bg-automation-changes-phone sm:-mx-4 sm:pb-7 sm:pt-[30px] sm:before:h-[260px]">
