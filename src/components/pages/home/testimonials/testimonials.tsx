...
const Testimonials = () => {
  return (
    <section className="testimonials pt-[176px] 2xl:pt-36 xl:pt-28 lg:pt-20 pb-[234px] 2xl:pb-[202px] xl:pb-[218px] lg:pb-[154px] md:pb-[130px] bg-cite">
      <div className="container">
        <figure className="flex flex-col items-center mx-auto max-w-[1048px] xl:max-w-[776px] lg:max-w-[590px] text-center">
          <QuoteIcon className="h-10 xl:h-8 lg:h-7 md:h-6" />
          <blockquote>
