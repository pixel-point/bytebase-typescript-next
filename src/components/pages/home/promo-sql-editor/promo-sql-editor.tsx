...
const PromoSQLEditor = () => {
  ...
  return (
    <section
      className="container relative mt-[62px] pt-[98px] 3xl:mt-[62px] 3xl:pt-[84px] xl:mt-[40px] xl:pt-[88px] md:mt-[30px] md:pt-[66px]"
      ref={ref}
    >
      <div className="absolute top-0 right-[96px] aspect-square h-auto w-[270px] 3xl:right-[76px] xl:w-[250px] md:right-[30px] md:w-[200px]">
        <RiveComponent />
      </div>
      <header>
      ...
      <div className="gap-x-grid mt-12 grid grid-cols-12 xl:mt-7 md:mt-10 sm:mt-6 sm:grid-cols-none">
