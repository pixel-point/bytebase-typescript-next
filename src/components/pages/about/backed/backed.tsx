...
const Backed = () => (
  <section className="container mt-40 3xl:mt-[144px] xl:mt-32 md:mt-24 sm:mt-20">
    <div className="gap-x-grid grid grid-cols-12 sm:grid-cols-4">
      ...
      <h2 className="col-span-full mt-3.5 justify-self-center text-center font-title text-88 font-semibold leading-none xl:mt-4 xl:text-68 md:mt-3 md:text-54 sm:text-48 sm:leading-95">
        Backed by the best
      </h2>
      <div className="col-span-6 row-start-3 mt-14 grid place-items-center border border-gray-90 bg-gray-97 py-[91px] 3xl:py-[83px] xl:mt-12 xl:py-[58px] md:mt-10 md:py-[105px] sm:col-span-4 sm:mt-8 sm:py-16">
        <Image
      ...
      <div className="col-span-6 row-start-3 mt-14 flex items-center border border-gray-90 xl:mt-12 md:mt-10 md:flex-col md:py-6 md:text-center sm:col-span-4 sm:row-start-4 sm:mt-4">
        <Image
