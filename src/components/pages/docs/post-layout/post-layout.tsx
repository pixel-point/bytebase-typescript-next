  ...
  return (
    <>
      <article className="col-start-4 col-span-6 lg:col-span-9 md:col-span-full">
        ...
        <h1 className="text-44 leading-extra-tight tracking-tighter font-bold text-gray-15">
          {title}
        </h1>
        ...
        <Link
          className="inline-flex mt-20 text-18 hover:text-gray-60 font-medium leading-none text-gray-15 items-center"
