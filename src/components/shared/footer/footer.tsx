...
const Footer = () => (
  <footer className="pt-20 lg:pt-14 sm:pt-12 xs:pt-10 safe-paddings z-50 shrink-0 container">
    <div className="grid grid-cols-12 grid-gap sm:grid-cols-4 sm:gap-x-4 sm:gap-y-10">
    ...
    <div className="mt-20 lg:mt-16 grid grid-cols-12 grid-gap xs:gap-x-0 py-6 border-t-4 border-tones-purple-light md:grid-rows-2 md:gap-y-6 md:py-5 xs:grid-rows-4 md:mt-[50px] xs:mt-[42px]">
      <div className="col-span-4 2xl:col-span-5 lg:col-span-6 flex items-center gap-x-9 md:flex-col md:gap-x-0 md:gap-y-6 md:items-start md:justify-center md:row-span-2 xs:row-span-1 xs:col-span-full">
