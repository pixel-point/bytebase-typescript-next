...
const Cards = () => {
  return (
    <ul className="mt-11 2xl:mt-7 lg:mt-8 md:mt-[25px] sm:-mt-[88px] grid grid-cols-3 grid-gap text-center sm:flex sm:flex-col sm:[&>li]:translate-y-0 sm:[&>li]:mt-4">
      ...
      <li className="flex flex-col items-center justify-between bg-tones-blue-light p-9 2xl:p-[31px] lg:p-[23px] md:p-[19px] md:pt-7 sm:px-6 sm:pt-7 sm:pb-5 lg:pb-8 border shadow-[inset_6px_6px_0_#fff,0_5px_15px_rgba(172,178,210,0.5)] border-tones-blue-dark lg:max-h-[400px] sm:items-start">
        <div className="flex flex-col items-center sm:items-start">
          <div className="flex flex-col items-center sm:flex-row">
