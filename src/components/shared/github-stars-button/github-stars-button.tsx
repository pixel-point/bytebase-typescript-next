...
const GithubStarsButton = () => (
  ...
  >
    <div className="bg-gray-97 flex items-center justify-center px-3 py-1.5 border border-gray-90 sm:border-0 rounded-l group-hover:bg-gray-90 sm:p-0 group-hover:border-gray-80 transition-colors duration-200 sm:bg-transparent sm:group-hover:bg-transparent">
      <GitHubIcon className="fill-black mr-1.5 h-4.5 w-4.5 sm:w-8 sm:h-8 sm:mr-3 sm:fill-white" />
      <span className="tracking-wider sm:tracking-wide">Star</span>
    </div>
    <span
